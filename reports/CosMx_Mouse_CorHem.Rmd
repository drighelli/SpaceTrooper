---
title: "CosMx Mouse Brain Coronal Hemisphere"
...
```{r}
dirname <- "/mnt/europa/data/spatial_omics/CosMx/Mouse brain/coronal_hemisphere"
prefix <- "Run1000_S1_Half"
...
out_dir <- sample_name <- "mouse_corhem"
# dir.create(out_dir)
```
