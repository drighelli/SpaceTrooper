---
title: "05_08_cosmx_human_BC_S3_custom_first_flag_scuttle"
...
```{r}
dirname <- "/data01/Shared/Benedetta/spatial_transcriptomics/CosMx/Datasets/TNBC/R5363_S3_188-B"
count_pattern <- "R5363_S3_188-B_exprMat_file.csv"
meta_pattern <- "R5363_S3_188-B_metadata_file.csv"
sample_name <- "CosMx_BC_Silvio"
```
...
```{r}
fov_pattern <- "R5363_S3_188-B_fov_positions_file.csv"
...
spat_obj <- fread(file.path(dirname, "R5363_S3_188-B-polygons.csv"))
...
ggplot() + 
  ...
  annotate("rect", xmin = fov_positions$x_global_px, 
           xmax = fov_positions$x_global_px + 5470, 
           ymin = fov_positions$y_global_px, 
           ymax = fov_positions$y_global_px + 3800,
           alpha = .2, color = "black",linewidth = 0.2) +
  geom_text(aes(x = fov_positions$x_global_px+5470/2,
                y = fov_positions$y_global_px+3800/2,
