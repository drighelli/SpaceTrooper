---
title: "05_08_xenium_human_lung_cancer_first_flag_scuttle"
...
spe$polygons_whole_custom$outlier_cellarea <- ifelse(spe$outlier_cellarea == TRUE, "red", "grey80")

tm_shape(spe$polygons_whole_custom) + 
  tm_fill(col = "outlier_cellarea") +
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = paste0("Outlier cells for custom cell area", 
...
spe$polygons_whole_custom$outlier_nucleusarea <- ifelse(spe$outlier_nucleusarea == TRUE, "red", "grey80")
...
```{r}
chr_nucleusarea <- replace_na(as.character(spe$outlier_nucleusarea), "NA_values")
nucleusarea_spe <- spe[, !chr_nucleusarea == "TRUE" ]
...
flagged_cells <- c(sum(spe$polygons_whole_custom$flagged_0total=="red", na.rm = T),
                   ...
                   sum(spe$polygons_whole_custom$outlier_cellarea=="red",na.rm = T),
                   sum(spe$polygons_whole_custom$outlier_nucleusarea=="red",na.rm = T))
...
unflagged_cells <- c(sum(spe$polygons_whole_custom$flagged_0total=="grey80", na.rm = T),
                     ...
                     sum(spe$polygons_whole_custom$outlier_cellarea=="grey80",na.rm = T),
                     sum(spe$polygons_whole_custom$outlier_nucleusarea=="grey80",na.rm = T))
...
union_flagged <- length(unique(c(spe[,spe$polygons_whole_custom$flagged_0total == "red"]$cell_id,
                   ...
                   spe[,spe$polygons_whole_custom$outlier_cellarea == "red"]$cell_id,
                   spe[,spe$polygons_whole_custom$outlier_nucleusarea == "red" & !is.na(spe$polygons_whole_custom$outlier_nucleusarea)]$cell_id)))
...
list_input <- list(flagged_0total = spe[,spe$polygons_whole_custom$flagged_0total == "red"]$cell_id, 
           ...
           cellarea_outlier = spe[,spe$polygons_whole_custom$outlier_cellarea == "red"]$cell_id,
           nucleusarea_outlier = spe[,spe$polygons_whole_custom$outlier_nucleusarea == "red" & !is.na(spe$polygons_whole_custom$outlier_nucleusarea)]$cell_id)
