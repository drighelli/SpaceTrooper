---
title: "CosMx Mouse Brain Hippo Ctx"
...
readCosmxSPE <- function(dirname=dirname, 
  ...
  # to add fov dimesions (they changes based on the technology) as metadata(spe)$fov_dim
...
```{r}
dirname <- "/mnt/europa/data/spatial_omics/CosMx/Mouse brain/coronal hippocampus and cortex"
prefix <- "Run5642_S3_Quarter"
fov_pattern <- paste0(prefix, "_fov_positions_file.csv")
count_pattern <- paste0(prefix, "_exprMat_file.csv")
meta_pattern <- paste0(prefix, "_metadata_file.csv")
