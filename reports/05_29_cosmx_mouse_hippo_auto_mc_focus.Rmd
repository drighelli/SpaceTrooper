---
title: "05_09_cosmx_mouse_hippo_auto_mc_focus"
...
polygons32 <- spe$polygons[spe$fov == 32,]
...
tm_shape(polygons32) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 32",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
...
```{r, out.width="150%", out.height="150%"}
polygons29 <- spe$polygons[spe$fov == 29,]
...
tm_shape(polygons29) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 29",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons39 <- spe$polygons[spe$fov == 39,]
...
tm_shape(polygons39) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 39",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons9 <- spe$polygons[spe$fov == 9,]
...
tm_shape(polygons9) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 9",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons50 <- spe$polygons[spe$fov == 50,]
...
tm_shape(polygons50) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 50",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons8 <- spe$polygons[spe$fov == 8,]
...
tm_shape(polygons8) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 8",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons66 <- spe$polygons[spe$fov == 66,]
...
tm_shape(polygons66) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 66",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0))+
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
