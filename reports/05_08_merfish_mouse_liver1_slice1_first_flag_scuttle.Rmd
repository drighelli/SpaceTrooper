---
title: "05_08_merfish_mouse_liver1_slice1_first_flag_scuttle"
...
union_flagged <- length(unique(c(spe[,spe$polygons_whole$flagged_0total == "red"]$cell_id,
                   ...
                   spe[,spe$polygons_whole$outlier_umarea == "red"]$cell_id)))
...
list_input <- list(flagged_0total = spe[,spe$polygons_whole$flagged_0total == "red"]$fov_id, 
           ...
           umarea_outlier = spe[,spe$polygons_whole$outlier_umarea == "red"]$cell_id)
