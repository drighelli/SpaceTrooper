---
title: "05_09_cosmx_mouse_hemi_auto_mc_focus"
...
spe$fov_id <- paste(spe$fov, spe$cell_id)
...
ggplot() + 
  ...
  annotate("rect", xmin = metadata(spe)$fov_positions$x_global_px, 
           xmax = metadata(spe)$fov_positions$x_global_px + fov_size, 
           ymin = metadata(spe)$fov_positions$y_global_px, 
           ymax = metadata(spe)$fov_positions$y_global_px + fov_size,
           alpha = .2, color = "black",linewidth = 0.2) +
  geom_text(aes(x = metadata(spe)$fov_positions$x_global_px+fov_size/2,
                y = metadata(spe)$fov_positions$y_global_px+fov_size/2,
...
polygons65 <- spe$polygons[spe$fov == 65,]
...
tm_shape(polygons65) + 
  ...
  tm_layout(legend.outside = TRUE,
            ...
            main.title = "Mc outlier cells in fov 65",
            main.title.size = 0.5, 
...
```{r, out.width="150%", out.height="150%"}
polygons46 <- spe$polygons[spe$fov == 46,]
...
tm_shape(polygons46) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 46",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons123 <- spe$polygons[spe$fov == 123,]
...
tm_shape(polygons123) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 123",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons79 <- spe$polygons[spe$fov == 79,]
...
tm_shape(polygons79) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 79",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons27 <- spe$polygons[spe$fov == 27,]
...
tm_shape(polygons27) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 27",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons100 <- spe$polygons[spe$fov == 100,]

tm_shape(polygons100) + 
  tm_fill(col = "outlier_fence_color", alpha = 0.5) +
  tm_borders(lwd = 0.1, col = "grey50") +
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 100",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons18 <- spe$polygons[spe$fov == 18,]
...
tm_shape(polygons18) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 18",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons97 <- spe$polygons[spe$fov == 97,]
...
tm_shape(polygons97) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 97",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons14 <- spe$polygons[spe$fov == 14,]
...
tm_shape(polygons14) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 14",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
