---
title: "05_29_cosmx_dbkero_BC_custom_mc_focus"
...
polygons1 <- spe$polygons[spe$fov == 1,]
...
tm_shape(polygons1) + 
  ...
  tm_layout(legend.outside = TRUE,
            ...
            main.title = "Mc outlier cells in fov 1",
            main.title.size = 0.5, 
...
```{r, out.width="150%", out.height="150%"}
polygons2 <- spe$polygons[spe$fov == 2,]
...
tm_shape(polygons2) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 2",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons5 <- spe$polygons[spe$fov == 5,]
...
tm_shape(polygons5) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 5",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons13 <- spe$polygons[spe$fov == 13,]
...
tm_shape(polygons13) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 13",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons22 <- spe$polygons[spe$fov == 22,]
...
tm_shape(polygons22) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 22",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons33 <- spe$polygons[spe$fov == 33,]
...
tm_shape(polygons33) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 33",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons11 <- spe$polygons[spe$fov == 11,]
...
tm_shape(polygons11) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 11",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
...
```{r, out.width="150%", out.height="150%"}
polygons45 <- spe$polygons[spe$fov == 45,]
...
tm_shape(polygons45) + 
  ...
  tm_layout(legend.outside = TRUE,
            main.title.position = c("center", "top"),
            main.title = "Mc outlier cells in fov 45",
            main.title.size = 0.5, 
            inner.margins = c(0, 0, 0, 0),
            outer.margins = c(0, 0, 0, 0)) +
    tm_add_legend(col = c("white", "darkturquoise", "magenta", "purple", "greenyellow","black", "red"),
